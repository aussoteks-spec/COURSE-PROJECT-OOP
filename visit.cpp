...
//сохранение истории пациента в отдельный текстовый файл
...
//добавляет запись о посещении для пациента
...
//удаляет конкретную запись о посещении
...
//возвращает отсортированный список посещений пациента
...
void VisitRepository::savePersonalVisitFile(const string& patientFIO) {
    try {
        ...
        cout << "Ошибка сохранения файла посещений: " << e.what() << endl;
        throw;
    }
}