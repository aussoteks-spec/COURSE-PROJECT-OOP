...
using namespace std;
//устанавливает цвета текста и фона по умолчанию
...
//находит текущий размер окна консоли
...
//создание меню в центре с управление на стрелочки
